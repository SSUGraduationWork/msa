...
public class FeedbackController {
    ...
    //    Members members=feedbackService.getUsers(memberId);
        ...
        List<MemberDto> memberRespons =boardService.teamMemberList(teamId);
        List<BoardFeedbackResponse> feedbacksList = feedbackRepository.findFeedbackByBoardsId(boardId);

        return  ResponseEntity.ok(CommentResponse.of(CommonCode.GOOD_REQUEST, feedbacksList,feedbackStatusesList, memberRespons));
    }
